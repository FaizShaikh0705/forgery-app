...
# List of keywords/phrases indicating a legitimate driving license
legit_keywords = ['Driving License', 'License Number']
...
if document_legit and has_picture:
    print("The driving license is considered legitimate and contains the document holder's picture.")
elif document_legit:
    print("The driving license is considered legitimate but may not contain the document holder's picture.")
else:
    print("The driving license is not considered legitimate.")
